...
echo 6. Switch Game Filter (OLD)(%GameFilterStatus%)
echo 7. Switch Game Filter (NEW)[!GameFilterStatus!]
...
if "%menu_choice%"=="6" goto game_switch_old
...
:game_switch_status
chcp 437 > nul
:: set "gameFlagFile1=%~dp0bin\game_filter.enabled"
